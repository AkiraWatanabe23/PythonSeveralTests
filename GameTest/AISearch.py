...
from MiniMaxTest import TicTacToe, Position

#AIの探索処理は、こちらに記述する
class Minimax_Search(TicTacToe, Position):
    ...
    def get_player_input_position(self, current_tic_tac_toe: TicTacToe) -> Position:
