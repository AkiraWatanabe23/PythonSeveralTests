...
#ex.)  変更可能(ミュータブル)なオブジェクト...list, dict
#      変更不可能(イミュータブル)なオブジェクト...文字列、数値、tuple

tup = (1, 2, 3, 4, 5)
print(id(tup))             # -> 1760480674496
print(id((1, 2, 3, 4, 5))) # -> 1760480674496
#↑同じID...tupと(1, 2, 3, 4, 5)は、同じ値が代入されている
tup += (6, 7, 8)
print(id(tup))             # -> 2948016817984
